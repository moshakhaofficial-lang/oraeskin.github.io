...
const TARGET_FILE = path.resolve('src/data/products.ts');
...
const products = [
  ...
  // ==========================================
  {
    ...
    skinType: ['All', 'Sensitive', 'Combination', 'Normal'],
    concerns: ['Sun Protection', 'Tanning', 'UV Damage', 'Pigmentation'],
    keyActives: ['Uvinul A Plus', 'Avobenzone', 'Niacinamide (Vitamin B3)', 'Vitamin B5'],
    keyIngredients: ['Niacinamide', 'Panthenol (Vitamin B5)', 'Tocopherol', 'Octocrylene', 'Avobenzone'],
    ingredients: ['Aqua', 'Octocrylene', 'Ethylhexyl Methoxycinnamate', 'Niacinamide', 'Panthenol', 'Titanium Dioxide', 'Glycerin'],
    ...
    alternatives: [
      { label: 'Matte Alternative for Oily Skin', productId: 'reequil-ultra-matte-spf50', reason: 'Provides a powdery dry-touch silicone finish that controls intense midday oiliness.' },
      { label: 'Water-Light Gel Alternative', productId: 'dermaco-hyaluronic-spf50', reason: 'Absorbs faster with zero dewy tackiness on sweat-prone days.' }
    ],
  ...
  },
  {
    ...
    skinType: ['Oily', 'Combination', 'Sensitive', 'Acne-Prone'],
    concerns: ['Clogged Pores', 'Midday Shine', 'Heavy Sweat', 'Sun Protection'],
    keyActives: ['1% Hyaluronic Acid', 'Vitamin E', 'Zinc Oxide', 'Titanium Dioxide'],
    keyIngredients: ['Hyaluronic Acid', 'Tocopheryl Acetate', 'Cyclopentasiloxane', 'Glycerin'],
    ingredients: ['Water', 'Ethylhexyl Methoxycinnamate', 'Butyl Methoxydibenzoylmethane', 'Hyaluronic Acid', 'Vitamin E'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Dewier Alternative for Normal Skin', productId: 'minimalist-spf50', reason: 'Offers more barrier lipids if your cheeks feel slightly tight.' },
      { label: 'Cooling Gel Alternative', productId: 'dotkey-watermelon-spf50', reason: 'Adds refreshing watermelon extract with an instant cooling sensation.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  },
  {
    ...
    concerns: ['Dullness', 'Heat Flush', 'Dehydration', 'Sun Protection'],
    keyActives: ['Watermelon Extract', 'Hyaluronic Acid', 'Beetroot Extract'],
    keyIngredients: ['Watermelon Fruit Extract', 'Sodium Hyaluronate', 'Beta Vulgaris Extract'],
    ingredients: ['Aqua', 'Citrullus Lanatus Fruit Extract', 'Ethylhexyl Methoxycinnamate', 'Hyaluronic Acid', 'Glycerin'],
    ...
    alternatives: [
      { label: 'Higher UVA Protection Alternative', productId: 'minimalist-spf50', reason: 'Upgrades to full PA++++ broad spectrum with zero fragrance.' },
      { label: 'Dewy Dry-Skin Alternative', productId: 'aqualogica-radiance-spf50', reason: 'Features niacinamide and watermelon with a rich water-burst texture.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  },
  {
    ...
    concerns: ['Dullness', 'Dry Patches', 'Pigmentation', 'Sun Protection'],
    keyActives: ['Watermelon Extract', 'Niacinamide', 'Hyaluronic Acid'],
    keyIngredients: ['Niacinamide', 'Sodium Hyaluronate', 'Watermelon Extract', 'Glycerin'],
    ingredients: ['Aqua', 'Octyl Methoxycinnamate', 'Niacinamide', 'Watermelon Extract', 'Glycerin'],
    fragrance: 'Subtle Natural Fragrance',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Barrier-Repair Alternative', productId: 'drsheths-ceramide-vitc-spf50', reason: 'Adds ceramides for extra barrier strengthening.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  },
  {
    ...
    concerns: ['Barrier Damage', 'Pigmentation', 'Sun Protection', 'Sensitivity'],
    keyActives: ['1% Ceramide Complex', '2% Vitamin C (Ascorbyl Glucoside)', 'Hyaluronic Acid'],
    keyIngredients: ['Ceramide NP', 'Ceramide AP', 'Ascorbyl Glucoside', 'Sodium Hyaluronate'],
    ingredients: ['Water', 'Ethylhexyl Salicylate', 'Ceramides', 'Ascorbyl Glucoside', 'Glycerin'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Budget Barrier Alternative', productId: 'minimalist-spf50', reason: 'Provides similar vitamin protection at ₹399.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  },
  {
    ...
    concerns: ['Heavy Sweating', 'Water Resistance', 'Extreme Humidity', 'Sun Protection'],
    keyActives: ['Zinc Oxide', 'Titanium Dioxide', 'Uvinul A Plus', 'Tinosorb S'],
    keyIngredients: ['Cyclopentasiloxane', 'Dimethicone Crosspolymer', 'Zinc Oxide', 'Titanium Dioxide'],
    ingredients: ['Cyclopentasiloxane', 'Zinc Oxide', 'Titanium Dioxide', 'Dimethicone', 'Tinosorb S'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Lightweight Water Gel Alternative', productId: 'dermaco-hyaluronic-spf50', reason: 'Easier to wash off without needing an oil cleanser.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  ...
  // ==========================================
  {
    ...
    concerns: ['Oiliness', 'City Pollution', 'Pore Cleansing', 'Barrier Health'],
    keyActives: ['3 Essential Ceramides (1, 3, 6-II)', 'Niacinamide', 'Hyaluronic Acid'],
    keyIngredients: ['Ceramide NP', 'Ceramide AP', 'Ceramide EOP', 'Niacinamide', 'Sodium Hyaluronate'],
    ingredients: ['Aqua', 'Cocamidopropyl Hydroxysultaine', 'Glycerin', 'Sodium Lauroyl Sarcosinate', 'Ceramides', 'Niacinamide'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Active Acne Alternative', productId: 'minimalist-salicylic-cleanser', reason: 'Adds 2% Salicylic Acid for active blackheads and whiteheads.' },
      { label: 'Hydrating Milk Alternative', productId: 'cetaphil-gentle-cleanser', reason: 'Zero foam formulation for severely dry or reactive skin.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  },
  {
    ...
    skinType: ['Oily', 'Combination', 'Acne-Prone'],
    concerns: ['Blackheads', 'Whiteheads', 'Active Pimples', 'Sebum Buildup'],
    keyActives: ['2% Salicylic Acid (BHA)', 'Capryloyl Salicylic Acid (LHA)', 'Zinc PCA'],
    keyIngredients: ['Salicylic Acid', 'Zinc PCA', 'Capryloyl Salicylic Acid', 'Allantoin'],
    ingredients: ['Aqua', 'Disodium Laureth Sulfosuccinate', 'Cocamidopropyl Betaine', 'Salicylic Acid', 'Zinc PCA'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Gentler Non-Exfoliating Alternative', productId: 'cerave-foaming-cleanser', reason: 'Better for everyday maintenance when active pimples have cleared.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  },
  {
    ...
    concerns: ['Dryness', 'Burning / Stinging', 'Eczema-Prone', 'Over-Exfoliation'],
    keyActives: ['Niacinamide (Vitamin B3)', 'Panthenol (Pro-Vitamin B5)', 'Glycerin'],
    keyIngredients: ['Glycerin', 'Niacinamide', 'Panthenol', 'Cetearyl Alcohol'],
    ...
    alternatives: [
      { label: 'Foaming Sensitive Alternative', productId: 'simple-refreshing-wash', reason: 'Light foam that still respects sensitive skin.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  },
  {
    ...
    concerns: ['Dull Complexion', 'Pigmentation', 'Uneven Tone'],
    keyActives: ['Rice Bran Water', 'Soapwort Extract', 'Moringa Oil'],
    keyIngredients: ['Oryza Sativa (Rice) Extract', 'Saponaria Officinalis Leaf Extract', 'Moringa Oleifera Seed Oil'],
    ingredients: ['Water', 'Myristic Acid', 'Glycerin', 'Potassium Hydroxide', 'Rice Extract'],
    fragrance: 'Subtle Natural Fragrance',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Barrier-First Alternative', productId: 'cerave-foaming-cleanser', reason: 'Maintains an acidic 5.5 pH with ceramides.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  },
  {
    ...
    concerns: ['Daily Cleansing', 'Redness', 'Sensitivity', 'Budget'],
    keyActives: ['Pro-Vitamin B5', 'Vitamin E', 'Triple Purified Water'],
    keyIngredients: ['Panthenol', 'Tocopheryl Acetate', 'Allantoin', 'Cocamidopropyl Betaine'],
    ingredients: ['Aqua', 'Cocamidopropyl Betaine', 'Propylene Glycol', 'Panthenol', 'Tocopheryl Acetate'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Acne-Targeting Alternative', productId: 'minimalist-salicylic-cleanser', reason: 'Adds 2% Salicylic Acid for breakout-prone skin.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  ...
  // ==========================================
  {
    ...
    skinType: ['All', 'Sensitive', 'Combination', 'Normal'],
    concerns: ['Dark Spots', 'Dullness', 'Sun Tan', 'Early Fine Lines'],
    keyActives: ['10% Ethyl Ascorbic Acid', '1% Centella Asiatica Extract', 'Polyhydroxy Acid (PHA)'],
    keyIngredients: ['Ethyl Ascorbic Acid', 'Centella Asiatica Water', 'Gluconolactone', 'Glycerin'],
    ingredients: ['Centella Asiatica Water', '3-O-Ethyl Ascorbic Acid', 'Gluconolactone', 'Ethoxydiglycol', 'Glycerin'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Higher Concentration Alternative', productId: 'plum-vitc-mandarin', reason: 'Features 15% concentration with Kakadu Plum for experienced users.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  },
  {
    ...
    concerns: ['Stubborn Sun Spots', 'Uneven Pigmentation', 'Loss of Radiance'],
    keyActives: ['15% Ethyl Ascorbic Acid', 'Kakadu Plum Extract', 'Japanese Mandarin Extract'],
    keyIngredients: ['3-O-Ethyl Ascorbic Acid', 'Terminalia Ferdinandiana Fruit Extract', 'Citrus Reticulata Peel Extract'],
    ingredients: ['Aqua', '3-O-Ethyl Ascorbic Acid', 'Propanediol', 'Kakadu Plum Extract', 'Mandarin Extract', 'Glycerin'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Beginner-Safe Alternative', productId: 'minimalist-vitc-10', reason: 'Gentler 10% dose with Centella for sensitive skin.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  },
  {
    ...
    skinType: ['Oily', 'Acne-Prone', 'Combination', 'Normal'],
    concerns: ['Enlarged Pores', 'Midday Greasiness', 'Post-Acne Blemishes', 'Uneven Texture'],
    keyActives: ['10% Pure Niacinamide (Vitamin B3)', '1% Zinc PCA', 'EUGROL G'],
    keyIngredients: ['Niacinamide', 'Zinc PCA', 'Aloe Barbadensis Leaf Juice', 'Dimethyl Isosorbide'],
    ingredients: ['Aqua', 'Niacinamide', 'Glycerin', 'Zinc PCA', 'Aloe Vera Leaf Juice', 'Phenoxyethanol'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Derma Co Niacinamide Alternative', productId: 'dermaco-10-niacinamide', reason: 'Adds Centella Asiatica for extra redness calming.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  },
  {
    ...
    skinType: ['All', 'Sensitive', 'Normal', 'Dry', 'Combination'],
    concerns: ['Melasma', 'Post-Acne Brown Marks (PIH)', 'Sun Tanning', 'Freckles'],
    keyActives: ['2% Alpha Arbutin', '1% Hyaluronic Acid', 'Hydroxyphenoxy Propionic Acid (HPA)'],
    keyIngredients: ['Alpha Arbutin', 'Sodium Hyaluronate', 'Glycerin', 'Dimethyl Isosorbide'],
    ingredients: ['Aqua', 'Alpha Arbutin', 'Propanediol', 'Sodium Hyaluronate', 'Phenoxyethanol'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Antioxidant Brightener Alternative', productId: 'minimalist-vitc-10', reason: 'Combines melanin reduction with collagen boosting.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  },
  {
    ...
    skinType: ['Oily', 'Combination', 'Acne-Prone'],
    concerns: ['Pore Texture', 'Acne Redness', 'Excess Sebum'],
    keyActives: ['10% Niacinamide', 'Zinc PCA', 'Centella Asiatica'],
    keyIngredients: ['Niacinamide', 'Zinc PCA', 'Centella Asiatica Extract', 'Glycerin'],
    ingredients: ['Water', 'Niacinamide', 'Zinc PCA', 'Centella Extract', 'Glycerin'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    texture: 'Fluid Gel',
    ...
    alternatives: [
      { label: 'Pure Formula Alternative', productId: 'minimalist-niacinamide-10', reason: 'Features Swiss Lonza-grade Niacinamide for ultra-sensitive skin.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  ...
  // ==========================================
  {
    ...
    skinType: ['Normal', 'Dry', 'Combination'],
    concerns: ['Barrier Damage', 'Rough Texture', 'Dehydration', 'Flakiness'],
    keyActives: ['Fermented Japanese Rice Water', 'Ceramides (NP, AP, EOP)', 'Hyaluronic Acid'],
    keyIngredients: ['Oryza Sativa (Rice) Bran Water', 'Ceramide Complex', 'Sodium Hyaluronate', 'Probiotic Ferment'],
    ingredients: ['Aqua', 'Rice Bran Water', 'Glycerin', 'Ceramide NP', 'Hyaluronic Acid', 'Shea Butter'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Oil-Free Alternative for Oily Skin', productId: 'minimalist-b5-moisturizer', reason: 'Ultra-lightweight oil-free formula with 10% Vitamin B5.' },
      { label: 'Ultra-Rich Medical Alternative', productId: 'cerave-moisturizing-cream', reason: 'Deeper occlusion for severely flaking skin.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  },
  {
    ...
    skinType: ['Dry', 'Sensitive', 'Normal'],
    concerns: ['Severe Dryness', 'Eczema', 'Stinging Skin', 'Post-Retinol Peeling'],
    keyActives: ['3 Essential Ceramides (1, 3, 6-II)', 'Hyaluronic Acid', 'MVE Delivery Technology'],
    keyIngredients: ['Ceramide NP', 'Ceramide AP', 'Ceramide EOP', 'Phytosphingosine', 'Cholesterol'],
    ingredients: ['Aqua', 'Glycerin', 'Cetearyl Alcohol', 'Caprylic/Capric Triglyceride', 'Ceramides', 'Dimethicone'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Lighter Gel-Cream Alternative', productId: 'dotkey-rice-ceramide-cream', reason: 'Absorbs faster for day use.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  },
  {
    ...
    skinType: ['Oily', 'Acne-Prone', 'Sensitive', 'Combination'],
    concerns: ['Acne Flare-Ups', 'Greasy T-Zone', 'Clogged Pores', 'Redness'],
    keyActives: ['10% Vitamin B5 (Panthenol)', 'Zinc Gluconate', 'Copper Gluconate', 'Magnesium Aspartate'],
    keyIngredients: ['Panthenol', 'Zinc Gluconate', 'Copper Gluconate', 'Betaine', 'Glycerin'],
    ingredients: ['Aqua', 'Panthenol', 'Glycerin', 'Betaine', 'Zinc Gluconate', 'Copper Gluconate'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Dewy Finish Alternative', productId: 'dotkey-rice-ceramide-cream', reason: 'Provides a more radiant finish with ceramides.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  },
  {
    ...
    concerns: ['Atopic Dermatitis', 'Extreme Itching', 'Cracked Barrier', 'Allergic Sensitivity'],
    keyActives: ['Lipigenium Complex', 'Skin Barrier Therapy Patent', 'PEA Anti-Itching Agent'],
    keyIngredients: ['Ceramides', 'Phytosphingosine', 'Palmitoylethanolamide (PEA)', 'Canola Oil'],
    ingredients: ['Aqua', 'Glycerin', 'Paraffinum Liquidum', 'Helianthus Annuus Seed Oil', 'Canola Oil', 'Ceramide NP'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Affordable Barrier Alternative', productId: 'cerave-moisturizing-cream', reason: 'High efficacy at a lower price point.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  ...
  // ==========================================
  {
    ...
    skinType: ['Normal', 'Oily', 'Combination'],
    concerns: ['Rough Texture', 'Dull Skin', 'Dark Elbows / Knees', 'Keratosis Pilaris'],
    keyActives: ['8% Pure Glycolic Acid (AHA)', 'Bamboo Water', 'Chamomile Extract'],
    keyIngredients: ['Glycolic Acid', 'Bambusa Vulgaris Water', 'Chamomilla Recutita Extract'],
    ingredients: ['Aqua', 'Glycolic Acid', 'Bambusa Vulgaris Water', 'Propanediol', 'Sodium Hydroxide'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Gentle Sensitive Skin Alternative', productId: 'minimalist-pha-toner', reason: 'Uses large-molecule PHA for zero irritation.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  },
  {
    ...
    concerns: ['Open Pores', 'Greasy T-Zone', 'Mild Breakouts'],
    keyActives: ['Green Tea Extract', '0.5% Glycolic Acid', 'Glycerin'],
    keyIngredients: ['Camellia Sinensis (Green Tea) Leaf Extract', 'Glycolic Acid', 'Glycerin'],
    ingredients: ['Aqua', 'Glycerin', 'Green Tea Extract', 'Glycolic Acid', 'Phenoxyethanol'],
    fragrance: 'Subtle Natural Fragrance',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Clinical Fragrance-Free Alternative', productId: 'minimalist-pha-toner', reason: 'Strictly fragrance-free with balancing prebiotics.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  },
  {
    ...
    concerns: ['Stinging Skin', 'Micro-Flakes', 'Microbiome Balance'],
    keyActives: ['3% Gluconolactone (PHA)', 'Multi-Biotics (Pre & Probiotics)', 'Polyglutamic Acid'],
    keyIngredients: ['Gluconolactone', 'Niacinamide', 'Polyglutamic Acid', 'Lactobacillus Ferment'],
    ingredients: ['Aqua', 'Gluconolactone', 'Niacinamide', 'Glycerin', 'Lactobacillus Ferment Lysate'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Higher Strength Exfoliant', productId: 'minimalist-glycolic-toner', reason: 'Stronger 8% AHA for resilient skin.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  },
  {
    ...
    concerns: ['Whiteheads', 'Blackheads', 'Daily Oil Maintenance'],
    keyActives: ['Willow Bark Water (Natural BHA)', 'Apple Fruit Water (Natural AHA)', 'Allantoin'],
    keyIngredients: ['Salix Alba (Willow) Bark Water', 'Pyrus Malus (Apple) Fruit Water', 'Glycolic Acid', 'Betaine Salicylate'],
    ingredients: ['Mineral Water', 'Salix Alba Bark Water', 'Pyrus Malus Fruit Water', 'Butylene Glycol', '1,2-Hexanediol'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Affordable Indian Alternative', productId: 'plum-greentea-toner', reason: 'High-value daily green tea toner under ₹400.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  ...
  // ==========================================
  {
    ...
    concerns: ['Dark Circles', 'Morning Eye Bags', 'Fine Dehydration Lines'],
    keyActives: ['3 Essential Ceramides', 'Marine & Botanical Complex', 'Niacinamide', 'Hyaluronic Acid'],
    keyIngredients: ['Ceramides (1, 3, 6-II)', 'Niacinamide', 'Sodium Hyaluronate', 'Chrysin'],
    ingredients: ['Aqua', 'Niacinamide', 'Cetyl Alcohol', 'Caprylic/Capric Triglyceride', 'Glycerin', 'Ceramides'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Caffeine Serum Alternative', productId: 'minimalist-caffeine-eye-serum', reason: 'Features 5% Caffeine for rapid fluid drainage and screen fatigue.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  },
  {
    ...
    concerns: ['Puffy Eyes', 'Late Night Fatigue', 'Vascular Dark Circles'],
    keyActives: ['5% High-Grade Caffeine', 'Green Tea EGCG', 'Matrixyl 3000 Peptide Complex'],
    keyIngredients: ['Caffeine', 'Epigallocatechin Gallatyl Glucoside', 'Palmitoyl Tripeptide-1', 'Hyaluronic Acid'],
    ingredients: ['Aqua', 'Caffeine', 'Glycerin', 'Propanediol', 'Palmitoyl Tripeptide-1', 'EGCG'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Moisturizing Cream Alternative', productId: 'cerave-eye-repair', reason: 'Adds deep ceramide lipids for dry orbital skin.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  },
  {
    ...
    concerns: ['Under-Eye Swelling', 'Eye Fatigue', 'Dark Circles'],
    keyActives: ['5% Caffeine', '1% Hyaluronic Acid', 'Retinol Peptide Blend'],
    keyIngredients: ['Caffeine', 'Sodium Hyaluronate', 'Peptides', 'Glycerin'],
    ingredients: ['Water', 'Caffeine', 'Hyaluronic Acid', 'Glycerin', 'Niacinamide'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    texture: 'Fluid Gel',
    ...
    alternatives: [
      { label: 'Higher Volume Dropper Alternative', productId: 'minimalist-caffeine-eye-serum', reason: 'Double the product (30ml) for the same price.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  ...
  // ==========================================
  {
    ...
    concerns: ['Lip Pigmentation', 'Sun Damage', 'Chapped Peeling Lips'],
    keyActives: ['Avobenzone & Uvinul Filters', 'Ceramide Complex', 'Hyaluronic Acid'],
    keyIngredients: ['Ceramides', 'Sodium Hyaluronate', 'Shea Butter', 'Petrolatum'],
    ingredients: ['Petrolatum', 'Microcrystalline Wax', 'Ceramide NP', 'Ethylhexyl Methoxycinnamate', 'Hyaluronic Acid'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Overnight Recovery Mask', productId: 'dotkey-lip-mask', reason: 'Ultra-rich overnight hydration with Shea Butter and Vitamin C.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  },
  {
    ...
    concerns: ['Dry Flaking Lips', 'Dehydration Fissures', 'Dull Pigmentation'],
    keyActives: ['Vitamin C (Ascorbyl Palmitate)', 'Vitamin E', 'Raw Shea Butter', 'Castor Oil'],
    keyIngredients: ['Shea Butter', 'Castor Seed Oil', 'Tocopherol', 'Ascorbyl Palmitate'],
    ingredients: ['Ricinus Communis Seed Oil', 'Butyrospermum Parkii Butter', 'Beeswax', 'Vitamin C', 'Vitamin E'],
    fragrance: 'Subtle Natural Fragrance',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Daytime SPF Alternative', productId: 'minimalist-spf30-lipbalm', reason: 'Adds SPF 30 protection for daytime sunlight.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  ...
  // ==========================================
  {
    ...
    skinType: ['Oily', 'Combination', 'All', 'Acne-Prone'],
    concerns: ['Back Acne (Bacne)', 'Strawberry Legs (KP)', 'Chest Pimples', 'Body Odor'],
    keyActives: ['2% Salicylic Acid (BHA)', 'Betaine', 'Zinc PCA'],
    keyIngredients: ['Salicylic Acid', 'Zinc PCA', 'Betaine', 'Glycerin'],
    ingredients: ['Aqua', 'Sodium Lauroyl Methyl Isethionate', 'Salicylic Acid', 'Zinc PCA', 'Betaine'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Nourishing Fragrance Alternative', productId: 'plum-bodylovin-vanilla-lotion', reason: 'Deep hydration with warm vanilla scent.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  },
  {
    ...
    skinType: ['Dry', 'Normal'],
    concerns: ['Dry Scaly Body Skin', 'Dull Body Texture', 'All-Day Scent'],
    keyActives: ['Shea Butter', 'Brazil Nut Oil', 'Sunflower Seed Oil'],
    keyIngredients: ['Butyrospermum Parkii Butter', 'Bertholletia Excelsa Seed Oil', 'Glycerin'],
    ingredients: ['Aqua', 'Helianthus Annuus Seed Oil', 'Glycerin', 'Shea Butter', 'Brazil Nut Oil'],
    ...
    alternatives: [
      { label: 'Clinical Exfoliating Alternative', productId: 'minimalist-salicylic-bodywash', reason: 'Targets acne and rough texture instead of scent.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  },
  {
    ...
    skinType: ['Normal', 'Dry'],
    concerns: ['Dryness', 'Daily Body Care', 'Budget Value'],
    keyActives: ['Pure Honey', 'Wheatgerm Oil', 'Seaweed Extract'],
    keyIngredients: ['Honey', 'Triticum Vulgare Germ Oil', 'Fucus Vesiculosus Extract'],
    ingredients: ['Water', 'Honey', 'Wheatgerm Oil', 'Seaweed Extract', 'Lotion Base'],
    fragrance: 'Subtle Natural Fragrance',
    essentialOils: true,
    alcoholFree: true,
    texture: 'Fluid Milk',
    ...
    alternatives: [
      { label: 'Clinical Treatment Alternative', productId: 'minimalist-salicylic-bodywash', reason: 'Focuses on active BHA exfoliation.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  ...
  // ==========================================
  {
    ...
    skinType: ['All'],
    concerns: ['Pus-Filled Pimples', 'Whiteheads', 'Skin Picking Urges'],
    keyActives: ['Medical-Grade Hydrocolloid', 'Salicylic Acid Infusion'],
    keyIngredients: ['Hydrocolloid Polymer', 'Salicylic Acid'],
    ingredients: ['Hydrocolloid Gel Matrix', 'Salicylic Acid'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Deep Cystic Gel Alternative', productId: 'sebogel-spot-gel', reason: 'Penetrates blind under-the-skin bumps with 2% Salicylic & Nicotinamide.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  },
  {
    ...
    concerns: ['Under-the-Skin Bumps', 'Inflamed Acne', 'Excess Sebum'],
    keyActives: ['2% Salicylic Acid', '6% Nicotinamide (Niacinamide)', 'Allantoin'],
    keyIngredients: ['Salicylic Acid', 'Nicotinamide', 'Allantoin', 'Carbomer'],
    ingredients: ['Aqua', 'Nicotinamide', 'Salicylic Acid', 'Propylene Glycol', 'Allantoin'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Surface Whitehead Patch', productId: 'dermaco-acne-patch', reason: 'Better for ripe pus-filled pimples.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  ...
  // ==========================================
  {
    ...
    skinType: ['All', 'Dry', 'Combination', 'Normal'],
    concerns: ['Fine Lines', 'Loss of Firmness', 'Uneven Texture', 'Adult Acne'],
    keyActives: ['0.3% Pure Retinol', 'Plant-Derived Squalane', '1% Coenzyme Q10'],
    keyIngredients: ['Pure Retinol', 'Squalane', 'Coenzyme Q10', 'Tocopherol'],
    ingredients: ['Squalane', 'Caprylic/Capric Triglyceride', 'Pure Retinol', 'Coenzyme Q10', 'Tocopherol'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Zero-Purging Retinoid Alternative', productId: 'minimalist-granactive-retinoid-2', reason: 'Next-gen HPR ester with zero peeling or irritation.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
  },
  {
    ...
    skinType: ['Sensitive', 'All', 'Dry', 'Combination'],
    concerns: ['Crow\'s Feet', 'Dull Tone', 'Early Wrinkles', 'Sensitive Aging'],
    keyActives: ['2% Granactive Retinoid (0.2% Hydroxypinacolone Retinoate)', 'Dimethyl Isosorbide'],
    keyIngredients: ['Hydroxypinacolone Retinoate', 'Dimethyl Isosorbide', 'Caprylic/Capric Triglyceride'],
    ingredients: ['Caprylic/Capric Triglyceride', 'Dimethyl Isosorbide', 'Hydroxypinacolone Retinoate', 'Tocopherol'],
    fragrance: 'Fragrance-Free',
    essentialOils: false,
    alcoholFree: true,
    ...
    alternatives: [
      { label: 'Classic Pure Retinol Alternative', productId: 'minimalist-retinol-03', reason: 'Proven traditional pure retinol in squalane.' }
    ],
    lastPriceChecked: 'September 2026',
    lastEditorialReview: 'September 2026',
    inStock: true
...
// Calculate exact OraeSkin Score using documented 6-factor weighting
function calculateOraeSkinScore(b) {
  const score = (
    b.formula * 0.25 +
...
// Ensure all products have computed score and backward compatibility
const enrichedProducts = products.map(p => {
  const oraeSkinScore = calculateOraeSkinScore(p.scoreBreakdown);
  return {
    ...p,
    oraeSkinScore,
    // Ensure backward compatibility with existing components
    scores: {
      formula: p.scoreBreakdown.formula,
      weatherResilience: p.scoreBreakdown.skinSuitability,
      texture: p.scoreBreakdown.skinSuitability,
      value: p.scoreBreakdown.value,
      overall: oraeSkinScore
    }
  };
});
...
export const PRODUCTS: SkincareProduct[] = ${JSON.stringify(enrichedProducts, null, 4)};
...
console.log(`Successfully generated ${enrichedProducts.length} enriched products in ${TARGET_FILE}`);
